...
namespace JWTtokenauthDemo.Migrations
{
    ...
    [Migration("20250107060359_UpdatesInTableFormApp")]
    partial class UpdatesInTableFormApp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JWT_token_auth_Demo.Models.form01application", b =>
                {
                    b.Property<string>("form01uin")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("form01address")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("form01contact_num")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("form01created_date")
                        .HasColumnType("datetime2");

                    b.Property<string>("form01created_name")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("form01deleted")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("form01last_name")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("form01middle_name")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("form01status")
                        .HasColumnType("bit");

                    b.Property<DateTime>("form01updated_date")
                        .HasColumnType("datetime2");

                    b.Property<string>("form01updated_name")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("form01uin");

                    b.ToTable("form01application");
                });

            modelBuilder.Entity("JWT_token_auth_Demo.Models.form02application_files", b =>
                {
                    b.Property<string>("form02uin")
                        .HasColumnType("nvarchar(450)");

                    b.Property<DateTime>("form02created_date")
                        .HasColumnType("datetime2");

                    b.Property<string>("form02created_name")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("form02deleted")
                        .HasColumnType("bit");

                    b.Property<string>("form02form01uin")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("form02img_name")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("form02img_path")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("form02status")
                        .HasColumnType("bit");

                    b.Property<DateTime>("form02updated_date")
                        .HasColumnType("datetime2");

                    b.Property<string>("form02updated_name")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("form02uin");

                    b.HasIndex("form02form01uin");

                    b.ToTable("form02application_files");
                });
            ...
            modelBuilder.Entity("JWT_token_auth_Demo.Models.form02application_files", b =>
                {
                    b.HasOne("JWT_token_auth_Demo.Models.form01application", "form01application")
                        .WithMany("form02application_files")
                        .HasForeignKey("form02form01uin")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("form01application");
                });
            ...
            modelBuilder.Entity("JWT_token_auth_Demo.Models.form01application", b =>
                {
                    b.Navigation("form02application_files");
                });
